...
<div class="wrap">
  ...
  <div class="tool-box">
    ...
    <div style="padding-top:7px;padding-bottom:7px;"> <code style="padding:7px;"> &lt;?php if (function_exists (g_aths_announcement)) g_aths_announcement(); ?&gt; </code></div>
 	<h2>About Plugin</h2>
	Plug-in created by <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/announcement-ticker-highlighter-scroller/'>www.gopiplus.com</a><br> 
	Check official website for live demo and more information <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/announcement-ticker-highlighter-scroller/'>click here</a><br> 
  </div>
</div>
<?php
}
...
{
	echo '<p>Announcement ticker highlighter scroller.<br><br>To change the setting goto Announcement ticker highlighter scroller link on setting menu<br>';
...
function g_aths_add_javascript_files() 
{
	if (!is_admin())
	{
		wp_enqueue_script( 'superb-slideshow-gallery', get_option('siteurl').'/wp-content/plugins/announcement-ticker-highlighter-scroller/announcement-ticker-highlighter-scroller.js');
	}
}    
