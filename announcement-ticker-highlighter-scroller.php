...
<div class="wrap">
  ...
  <div class="tool-box">
	...
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/announcement-ticker-highlighter-scroller/'>Click here</a> to post suggestion or comments or feedback. <br> 
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/announcement-ticker-highlighter-scroller/'>Click here</a> to see live demo. <br> 
...
{
	add_options_page('Announcement ticker highlighter scroller', 'Announcement ticker highlighter scroller', 'manage_options', __FILE__, 'g_aths_admin_options' );
	add_options_page('Announcement ticker highlighter scroller', '', 0, "announcement-ticker-highlighter-scroller/setting.php",'' );
}
...
function g_aths_control()
{
	...
	<h2><?php echo wp_specialchars( 'About Plugin' ); ?></h2>
	Plug-in created by <a target="_blank" href='http://www.gopiplus.com/'>Gopi</a>. <br> 
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/announcement-ticker-highlighter-scroller/'>Click here</a> to post suggestion/comments/feedback. <br> 
	<a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/announcement-ticker-highlighter-scroller/'>Click here</a> to see live demo. <br> 
	<a target="_blank" href='http://www.gopiplus.com/work/plugin-list/'>Click here</a> to download my other plugins. <br> 
	<?php
}
...
function g_aths_widget_init() 
{
	...
	{
		register_widget_control(array('Announcement ticker highlighter scroller', 'widgets'), 'g_aths_control');
	} 
}
