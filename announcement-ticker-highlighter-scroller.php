  ...
  <form name="form_aths" method="post" action="<?php echo $mainurl; ?>" onsubmit="return aths_submit()"  >
    <table width="100%">
      ...
      <tr>
        ...
        <td width="40%" rowspan="3" align="center" valign="top"><?php if (function_exists (timepass)) timepass(); ?>
        </td>
      </tr>
      <tr>
      ...
      <tr>
        <td height="35" colspan="2" align="left" valign="bottom"><input name="publish" lang="publish" class="button-primary" value="<?php echo $submittext?>" type="submit" />
          <input name="publish" lang="publish" class="button-primary" onclick="_g_aths_redirect()" value="Cancel" type="button" /></td>
