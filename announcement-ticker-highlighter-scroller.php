...
<div class="wrap">
    ...
    <table width="100%">
      ...
      <tr>
        <td height="35" colspan="3" align="left" valign="bottom"><input name="publish" lang="publish" class="button-primary" value="<?php echo @$submittext?>" type="submit" />
          ...
          <input name="Help" lang="publish" class="button-primary" onclick="window.open('http://www.gopipulse.com/work/2010/07/18/announcement-ticker-highlighter-scroller/');" value="Help" type="button" />
  ...
  <div class="tool-box">
	...
	<br />Check official website for more information <a target="_blank" href='http://www.gopipulse.com/work/2010/07/18/announcement-ticker-highlighter-scroller/'>click here</a><br> 
  </div>
</div>
<?php
}
